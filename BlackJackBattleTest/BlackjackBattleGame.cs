...
{
    private const int StartingPlayerHearts = 4;
    ...
    public void StartNewRound()
    {
        ...
        // If the deck gets low, reset it.
        if (deck.CardsRemaining < 15)
        {
            deck.Reset();
        }

        // Deal two cards to every alive player.
        ...
        // If a player starts with blackjack, they automatically stand.
        foreach (BlackjackPlayer player in Players.Where(player => !player.IsDefeated))
        {
